...
public class ThreeCapHeuristic {
    ...
    // used in merge step
    private float splitPairsDivisor;
     ...
     */
    public List<List<Integer>> computeCompatibleItemTriples(List<MCMEdge> itemPairs, List<Integer> unmatchedItems) {
        ...
        List<List<Integer>> itemTriples = GraphUtil.parseItemTripleFromMCM(mcm);
        return itemTriples;
    }
     ...
     */
    public Graph<String, DefaultEdge> generateStackingConstraintGraph(int[] items) {
     ...
     */
    public List<MCMEdge> generateItemPairs(int[] items) {
     ...
     */
    public List<Integer> getLevelsOfOtherSlots(int level) {
     ...
     */
    public void addEdgeForStacksWithSingleItemToPostProcessingGraph(
     ...
     * @param originalCosts       - current costs for each item assignment
     */
    public void addEdgeForStacksFilledWithPairsToPostProcessingGraph(
     ...
     */
    public void restoreStackAssignmentsForBestOriginalSolution(Solution sol) {
