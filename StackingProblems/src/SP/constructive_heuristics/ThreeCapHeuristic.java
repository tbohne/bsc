...
public class ThreeCapHeuristic {
     ...
     * @param prioritizedRuntime - determines whether runtime is prioritized instead of solution quality
     */
    public ArrayList<ArrayList<ArrayList<Integer>>> mergePairsToTriples(ArrayList<MCMEdge> itemPairs, boolean prioritizedRuntime) {
     ...
     */
    public Solution solve(boolean prioritizeRuntime) {
