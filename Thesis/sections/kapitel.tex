...
Die Kosten ergeben sich aus der Manhattan-Distanz zwischen Item- und zugewiesener Stack-Position, da diese der Kranbewegung entspricht. In Abb. \ref{fig:costs} ist ein Beispielszenario visualisiert, in welchem die Items auf Zügen geliefert und dann durch Kräne auf die ihnen zugewiesenen Stackpositionen in der Storage-Area verladen werden.
\begin{figure}[H]
