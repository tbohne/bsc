...
Die Länge eines Items wird dementsprechend zufällige aus dem Intervall $[1.0, 6.0]$ generiert während die Breite aus dem
Intervall $[1.0, 2.4]$ stammt. Die konkreten Maße der Items sind für die Transportkosten irrelevant und lediglich
