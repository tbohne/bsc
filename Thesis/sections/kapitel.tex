...
sich der Zielfunktionswert um durchschnittlich $0.007 \%$. Trotz der vergleichsweise geringen Verbesserung der durchschnittlichen Kosten,
...
kann diese jenem durch die Option noch einmal näher kommen. Wenn also eine Laufzeit von wenigen Sekunden, welche
im Vergleich zu den MIP-Formulierungen weiterhin um Größenordnungen schneller ist, akzeptabel ist, kann diese Option
genutzt werden.
...
wird in den folgenden Experimenten auf \textit{true} gesetzt, weil sowohl die Laufzeiten als auch die Zielfunktionswerte der einzelnen Solver
miteinander verglichen werden und die Auswirkung dieser Option auf die Laufzeit größer ist, als jene auf den Zielfunktionswert.
Ist in der Praxis eine Laufzeit von wenigen Sekunden akzeptabel und lediglich der Zielfunktionswert wesentlich,
so kann dieser Parameter auf \textit{false} gesetzt werden und es lassen sich bei einigen der Instanzen geringfügig bessere
Zielfunktionswerte erzielen.
