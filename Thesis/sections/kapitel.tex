...
Die Stacking-Constraint-Matrix $S$ wird ebenfalls, wie in \ref{sec:test_data} beschrieben, generiert.
Basierend auf dieser wird der in Abb. \ref{fig:stacking_const_graph_example_b=2_a} dargestellte Stacking-Constraint-Graph
für die gegebenen Items generiert. Darauf wird das in \ref{fig:stacking_const_graph_example_b=2_b} in grün dargestellte \textsc{MCM} berechnet, wobei Item 0 unmatched ist.
\begin{figure}[H]
  \centering
    \begin{subfigure}[b]{0.4\textwidth}
    \centering
...
Das für den bipartiten Graphen berechnete \textsc{MWPM} ist in Abb. \ref{fig:mwpm} dargestellt. Jede
Kante entspricht dabei einer Zuweisung eines Item-Paars bzw. Unmatched Items zu einem Stack.
Die entsprechende Interpretation als zulässige Stack-Zuweisung ist in \ref{fig:stacking_solution} abgebildet.
