...
In Orientierung am TEU betragen Länge und Breite einer Zelle in den Experimenten $6.06$ bzw. $2.44$ Meter.
Ebenfalls konfigurierbar ist die erwähnte Distanz zwischen den beiden Grids, welche in den Experimenten dem
Fünffachen der Zellenbreite, also in diesem Fall $12.20$ Metern entspricht.
...
Die Länge eines Items wird dementsprechend zufällige aus dem Intervall $[1.00, 6.06]$ generiert während die Breite aus dem
Intervall $[1.00, 2.44]$ stammt. Die konkreten Maße der Items sind für die Transportkosten irrelevant und lediglich
