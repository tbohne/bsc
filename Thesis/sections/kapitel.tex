...
$\forall s \in S, t \in T \thinspace \exists \thinspace \{s, t\} \in A$. Außerdem wird erwartet, dass beide Partitionen gleich groß sind,
...
vorgestellt. Diese erweitert den Ansatz aus dem Beweis zu Theorem 1 aus \textquote{Complexity Results for Storage Loading Problems with Stacking Constraints}, welches 2015 von \citet{Bruns2015} veröffentlicht wurde.
