...
werden können, während die Zuweisung echter Items und Item-Paare stets Kosten verursachen. Dementsprechend werden
...
jedoch noch nicht berücksichtigt. Diese Sortierung kann durch den Algorithmus \ref{alg:algo1} erfolgen.
