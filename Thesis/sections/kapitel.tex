...
welches die Kanten dieses \textsc{MCM} interpretiert als Item-Paare zeigt.
...
und die Stacks in der anderen Partition. Anschließend wird ein \textsc{MWPM} in diesem Graphen berechnet, welches
